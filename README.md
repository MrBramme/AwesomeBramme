...
- [Clean code snippets .NET](https://github.com/thangchung/clean-code-dotnet): Clean code snippets mapped to c# examples
...
- [Hey Meta](https://www.heymeta.com/): Check your site's metadata
